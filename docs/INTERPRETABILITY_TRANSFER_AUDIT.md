...
5. **Run — EXP-R2-098, and it splits the protein family.** ProGen2-base reads
   ...
   **+0.527** on ProGen2-base against +0.777 and +0.784 on the text controls and
   ...
   neither a scale nor an architecture effect. **EXP-R2-103 completes the family:
