...
| Protein-specific measurement substrate | **strong** — source of six retractions (L11, L13, L15, L23 and the corpus-repeat asymmetry). **Recorded as "strongest" until 2026-08-09**, on the strength of L22, which is no longer its member |
