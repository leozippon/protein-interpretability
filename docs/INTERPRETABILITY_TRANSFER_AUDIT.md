...
| F8 | The **thirty-one** catalogued limitations of §5 (L1–L31; recorded here as twenty-three until 2026-08-09, then twenty-six before L27 was added the same day, and twenty-seven until 2026-08-12, when L28 to L31 were added), each scoped as **method** or **transfer** under §5's own organising rule — no row carries any other scope | as cited per row in §5 | **frozen as a rule; the count moves with the catalogue** |
...
2. **Check gate attainability on the text control before applying it to a protein arm.** A gate the positive control cannot pass is a specification defect. (Four instances: the two this rule was written on, a third recorded at §D2.c's blocker list, and a fourth at §8 item 0b. Recorded as two until 2026-08-09.)
