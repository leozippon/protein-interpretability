...
>
> - **On exact probes the noise mass *is* matched across modalities, so concentration is interpretable there, and the ZymCTRL exception is real** — its Gini of 0.607 against 0.78–0.94 elsewhere stands at reliability 0.823 and cannot be deflated into agreement with the rest of the panel.
...
**EXP-R2-079 — the cross-lab control, and a miscalibrated pre-registration.** Exhaustive over every head; all five structural invariants pass at ≤2.5e-06 against a 1e-03 tolerance on both arms.
