...
5. **Property-conditioned Jacobian in its probe-derived form** — standing rejection. §8 item 3, carried into the plan as D3.b (aperture-functional attribution), is the accepted narrow version and is labelled so it is not mistaken for a revival. *(Cited as "§8.3" until 2026-08-09; §8's items have never been numbered as subsections, and item 3 is the one the retired-name table maps to C2 → D3.b.)*
