...
6. **The two readings of D2.c partition the panel differently (EXP-R2-099/100).**
   ...
   |---|---|---|---|
   | **size** (ΔM-gap ÷ clean M-gap) | **7.18%** | **0.93%** | **yes, no overlap** |
   | ranking (census-to-causal ρ) | +0.4685 | +0.2145 | **no** |

   By size the four protein arms sit in a tight band — ProtGPT2 0.77% and 0.49%,
   ProGen2-base 0.65%, ProGen2-medium 0.62%, ProGen2-small 0.93% — below both text
   conditions. By
...
7. **What the census contributes is directional, and only on text (EXP-R2-099).**
   ...
   **Re-checked on two ProGen2 arms and in both conditions (EXP-R2-100), and the
   ...
   +0.03, ProGen2-base −0.02, ProGen2-medium +0.01, ProGen2-small +0.14. **Only gpt2-large's
   census top is directionally selective, and it selects for *promoting* heads; no
   protein arm shows the enrichment in either direction.** ProGen2-base's −0.26 under the measurability restriction against −0.02
