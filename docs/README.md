...
The three `audits/` documents are dated snapshots. Their paths predate both the 2026-07-16 standardization and the 2026-07-29 rename, and are not normalized.

## Where scientific status lives

Not here. `../docs/INTERPRETABILITY_TRANSFER_AUDIT.md` is the canonical record of what has been measured, what survived and what was withdrawn. These documents describe the repository; that one describes the science.

## Entry points

`../README.md`, `../AGENTS.md`, and `DOCUMENT_INDEX.md`.
