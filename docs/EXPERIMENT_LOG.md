...
*Gate withdrawn.* Top-20 Jaccard ≥ 0.8 is met by no arm in any condition; the best is 0.667 and the text control never exceeds 0.429. Second gate this session unattainable on its own positive control (standing rule 2). Answered on the threshold-free ρ instead.
