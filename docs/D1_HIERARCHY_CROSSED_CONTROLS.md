...
## Full-panel extension: prepared, interface-qualified, not fitted

After the five-arm result above was complete and admitted, the readout expansion campaign passed its own final admission, and extending this contrast to its panel was authorised. The extension is prepared and its interfaces are qualified; its fitting run has not been executed, because every H200 card was claimed by another campaign before it could be dispatched. Nothing in this section is a result.
