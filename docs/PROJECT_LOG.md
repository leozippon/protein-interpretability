...
- Withdrew **two** pre-registered gates as specification defects after showing neither is attainable on its own text control — the ≥30 far-band case gate and the top-20 Jaccard ≥ 0.8 causal-agreement gate. Standing rule 2 had been violated in the recording direction in both cases.
