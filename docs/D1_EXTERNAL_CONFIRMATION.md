...
**Zero resolved sign changes over 1,386 compared summary nodes**, and no arm-and-metric pair changes at any seed, let alone all three. The table above is the four licensed quantities — the primary and secondary likelihood and representation increments, 396 nodes. The comparison itself covers every node of both records carrying a point and an interval: 1,386 across the 33 arms, 396 likelihood, 396 representation and 594 baseline, null and tokenisation nodes, with no node present in one record and absent from the other in either direction. The wider set adds no movement above the licensed four — its largest are the same 3.69e-16 in a point and 1.41e-15 in an interval endpoint — and unlike the folding-stability record this one carries no stratification block for a movement to hide in.

**The null is not silence, because the control could have fired.** 464 of the 1,386 compared nodes had an interval endpoint close enough to zero that the movement observed in their own cell could have carried it across — 336 likelihood, 29 representation and 99 other, of which 168 and 13 sit among the four licensed quantities — and none crossed. Read like for like on the licensed quantities across three gates — 254 on crossed controls, 136 on folding and stability, 168 here — quantities at risk did not move, which makes that a property of the measurement rather than a feature of one gate.
