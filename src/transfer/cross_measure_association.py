...
# Already-recorded quantities only. Pending generation and pending MegaScale
# stay empty. G1 for the original fifteen-arm protein cells is unavailable
# until an 01-design eight-block envelope is located.
CELLS: dict[str, dict[str, Cell]] = {
    "protgpt2": {
        ...
        "U1": _c("pending", note="EXP-R2-246"),
        "U2": _c("pending", note="EXP-R2-246"),
        "U3": _c("pending", note="EXP-R2-246 plus structure"),
        "U4": _c("pending", note="EXP-R2-246 plus structure"),
        "U5": _c("pending", note="EXP-R2-246 plus reference search"),
    },
    "zymctrl": {
        "G1": _c("unavailable", note="no 01-design eight-block min lower located"),
        ...
        "C3": _c("available", 56.68),
        "C4": _c("available", 0.8636),
    ...
    "progen3-3b": {
        ...
        "U3": _c("available", 38.39),
        "U4": _c("available", 0.4307),
    ...
    "galactica-125m": {
        ...
        "S3": _c("pending", note="s29 MegaScale"),
    ...
    "llama-2-7b": {
        ...
        "S1": _c("pending", note="read MODEL-LOOKUP from the lineage analyse artefact"),
    ...
    "prollama": {
        ...
        "C3": _c("available", 5.92),
        "C4": _c("available", 0.0136),
