...
staging, AlphaMissense, gMVP, and ESM-1v are scored. AlphaMissense and gMVP are
stronger on raw pathogenicity (ClinVar2000 AUC **0.9474** and **0.9369**), so
R1's reviewer-facing novelty cannot be framed as beating scalar pathogenicity
...
4. T1-A competitor baselines are mostly scored: AlphaMissense, gMVP, and
   ESM-1v are available; PrimateAI-3D remains gated/pending
...
### Next Improvements
- Add PrimateAI-3D after approval, then refresh the unified competitor table
...
- [ ] Stage PrimateAI-3D after gated approval and refresh T1-A
